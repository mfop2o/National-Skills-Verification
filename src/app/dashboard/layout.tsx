...
const navigation = {
  user: [
    ...
    { name: 'Portfolio', href: '/user/portfolio', icon: FolderIcon },
    { name: 'Certificates', href: '/user/certificates', icon: AcademicCapIcon },
    { name: 'Skills & Badges', href: '/user/skills', icon: ShieldCheckIcon },
    { name: 'Profile', href: '/user/profile', icon: UserIcon },
  ],
  institution: [
    { name: 'Dashboard', href: '/institution/dashboard', icon: HomeIcon },
    { name: 'Verification Queue', href: '/institution/verifications', icon: AcademicCapIcon },
    { name: 'Issued Badges', href: '/institution/badges', icon: ShieldCheckIcon },
    { name: 'Profile', href: '/institution/profile', icon: BuildingOfficeIcon },
  ],
  employer: [
    { name: 'Dashboard', href: '/employer/dashboard', icon: HomeIcon },
    { name: 'Search Talent', href: '/employer/search', icon: BriefcaseIcon },
    { name: 'Verifications', href: '/employer/verify', icon: ShieldCheckIcon },
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                  <div className="flex h-16 shrink-0 items-center">
                    ...
                    <span className="ml-2 text-xl font-semibold">SkillTrust</span>
                  </div>
